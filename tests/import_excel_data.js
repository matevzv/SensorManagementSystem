...
var settings_content = fs.readFileSync("./tests/test_data/data_from_excel_files.json");
...
fs.writeFileSync("./tests/test_data/data_from_excel_files_out.json", JSON.stringify(datax, null, "  "));
fs.writeFileSync("./tests/test_data/data_from_excel_files_out2.json", JSON.stringify(data, null, "  "));
