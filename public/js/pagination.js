...
function paginate_nodes(num, elementsPerPage) {
    var elementsTotal = document.getElementsByClassName('nodes_border').length;
    var pagesTotal = Math.ceil(elementsTotal / elementsPerPage);
   // console.log("Pagination function call! no of pages = " + pagesTotal + " total elements = " + elementsTotal);
    ...
    var elementsAll = document.getElementsByClassName('nodes_border');
